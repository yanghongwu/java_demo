...
public class LeastSquareMethod {
    ...
    public static void main(String[] args) {
        LeastSquareMethod eastSquareMethod = new LeastSquareMethod(
                new double[] { 8, 16, 24, 32, 40, 48 }, new double[] {
                5000, 7000, 15000, 16000, 20000, 30000 }, 4);

        System.out.println(eastSquareMethod.fit(64));

        LeastSquareMethod eastSquareMethod2 = new LeastSquareMethod(
                new double[] { 8, 16, 24, 32, 40, 48 }, new double[] {
                5000, 7000, 15000, 16000, 20000, 30000 }, 4);
        System.out.println(eastSquareMethod2.solve(30000));

        System.out.println(eastSquareMethod2.solve(40000));
